# Celtic Mythology - Structure & Data Guidelines

**Tradition Color:** #228B22
**Icon:** 🍀
...
### Color Scheme:
```css
--mythos-primary: #228B22;
--mythos-secondary: #32CD32;
```
...
- path/ (6 stages: Ollaire, Bard, Ovate, Druid, High Druid, Arch-Druid)
- texts/ (sacred writings)
- symbols/ (sacred symbols, sigils)

## Cross-Tradition Deity Mappings

Link Celtic deities to similar figures in other traditions.
See `_documentation/TEMPLATE_GUIDE.md` for deity equivalence table.

## Celtic-Specific Features

### Spiritual Path (6 Stages)
1. **Ollaire** (Stage 1) - 0-1 years
2. **Bard** (Stage 2) - 1-5 years
3. **Ovate** (Stage 3) - 5-10 years
4. **Druid** (Stage 4) - 10-15 years
5. **High Druid** (Stage 5) - 15-20 years
6. **Arch-Druid** (Stage 6) - 20+ years
...
Every Celtic page should link to similar concepts in:
...
- [ ] Uses correct color scheme (#228B22, #32CD32)
