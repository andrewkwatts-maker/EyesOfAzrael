# Babylonian Mythology - Structure & Data Guidelines

**Tradition Color:** #483D8B
**Icon:** 🦁
...
- path/ (6 stages: Apprentice, Baru Diviner, Ashipu Exorcist, Mašmaššu, Ummânu, Chief Scholar)
- texts/ (sacred writings)
- symbols/ (sacred symbols, sigils)

## Cross-Tradition Deity Mappings

Link Babylonian deities to similar figures in other traditions.
See `_documentation/TEMPLATE_GUIDE.md` for deity equivalence table.

## Babylonian-Specific Features

### Spiritual Path (6 Stages)
1. **Apprentice** (Stage 1) - 0-1 years
2. **Baru Diviner** (Stage 2) - 1-5 years
3. **Ashipu Exorcist** (Stage 3) - 5-10 years
4. **Mašmaššu** (Stage 4) - 10-15 years
5. **Ummânu** (Stage 5) - 15-20 years
6. **Chief Scholar** (Stage 6) - 20+ years
...
Every Babylonian page should link to similar concepts in:
...
- [ ] Uses correct color scheme (#483D8B, #6A5ACD)
