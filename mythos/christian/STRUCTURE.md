# Christian Mythology - Structure & Data Guidelines
...
### Color Scheme:
```css
--mythos-primary: #4169E1;
--mythos-secondary: #6495ED;
```
...
- path/ (6 stages: Catechumen, Layperson, Deacon, Priest, Bishop, Patriarch/Pope)
- texts/ (sacred writings)
- symbols/ (sacred symbols, sigils)

## Cross-Tradition Deity Mappings

Link Christian deities to similar figures in other traditions.
See `_documentation/TEMPLATE_GUIDE.md` for deity equivalence table.

## Christian-Specific Features

### Spiritual Path (6 Stages)
1. **Catechumen** (Stage 1) - 0-1 years
2. **Layperson** (Stage 2) - 1-5 years
3. **Deacon** (Stage 3) - 5-10 years
4. **Priest** (Stage 4) - 10-15 years
5. **Bishop** (Stage 5) - 15-20 years
6. **Patriarch/Pope** (Stage 6) - 20+ years
...
- [ ] Create 3 priority deity pages: God (Trinity), Jesus Christ, Holy Spirit
- [ ] Create cosmology/creation.html (STANDARDIZED)
- [ ] Create cosmology/afterlife.html (STANDARDIZED)

**Week 2:**
- [ ] Create herbs/index.html
- [ ] Create 3 priority herb pages: Frankincense, Myrrh, Hyssop
...
Every Christian page should link to similar concepts in:
...
- [ ] Uses correct color scheme (#4169E1, #6495ED)
