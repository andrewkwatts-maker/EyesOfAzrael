# Roman Mythology - Structure & Data Guidelines

**Tradition Color:** #B22222
**Icon:** 🏛️
...
### Color Scheme:
```css
--mythos-primary: #B22222;
--mythos-secondary: #DC143C;
```
...
- path/ (6 stages: Acolyte, Camillus, Flamen, Augur, Pontifex, Pontifex Maximus)
- texts/ (sacred writings)
- symbols/ (sacred symbols, sigils)

## Cross-Tradition Deity Mappings

Link Roman deities to similar figures in other traditions.
See `_documentation/TEMPLATE_GUIDE.md` for deity equivalence table.

## Roman-Specific Features

### Spiritual Path (6 Stages)
1. **Acolyte** (Stage 1) - 0-1 years
2. **Camillus** (Stage 2) - 1-5 years
3. **Flamen** (Stage 3) - 5-10 years
4. **Augur** (Stage 4) - 10-15 years
5. **Pontifex** (Stage 5) - 15-20 years
6. **Pontifex Maximus** (Stage 6) - 20+ years
...
Every Roman page should link to similar concepts in:
...
- [ ] Uses correct color scheme (#B22222, #DC143C)
