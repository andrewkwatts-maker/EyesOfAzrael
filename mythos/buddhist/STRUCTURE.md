# Buddhist Mythology - Structure & Data Guidelines
...
### Color Scheme:
```css
--mythos-primary: #FFD700;
--mythos-secondary: #FFA500;
```
...
- path/ (6 stages: Lay Practitioner, Novice Monk, Monk, Elder, Arahant, Bodhisattva)
- texts/ (sacred writings)
- symbols/ (sacred symbols, sigils)

## Cross-Tradition Deity Mappings

Link Buddhist deities to similar figures in other traditions.
See `_documentation/TEMPLATE_GUIDE.md` for deity equivalence table.

## Buddhist-Specific Features

### Spiritual Path (6 Stages)
1. **Lay Practitioner** (Stage 1) - 0-1 years
2. **Novice Monk** (Stage 2) - 1-5 years
3. **Monk** (Stage 3) - 5-10 years
4. **Elder** (Stage 4) - 10-15 years
5. **Arahant** (Stage 5) - 15-20 years
6. **Bodhisattva** (Stage 6) - 20+ years
...
- [ ] Create 3 priority deity pages: Buddha, Avalokiteshvara, Manjushri
- [ ] Create cosmology/creation.html (STANDARDIZED)
- [ ] Create cosmology/afterlife.html (STANDARDIZED)

**Week 2:**
- [ ] Create herbs/index.html
- [ ] Create 3 priority herb pages: Bodhi Tree, Lotus, Sandalwood
...
Every Buddhist page should link to similar concepts in:
...
- [ ] Uses correct color scheme (#FFD700, #FFA500)
