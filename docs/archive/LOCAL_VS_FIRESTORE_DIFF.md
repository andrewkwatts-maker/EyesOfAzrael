...
- **christian_144000** - Revelation 7, 14 (christian)
- **christian_babylon-fall-detailed** - Isaiah, Jeremiah, and Revelation Phrase (christian)
- **christian_babylon-falls** - Revelation 17 (christian)
- **christian_beast-kingdoms-progression** - Daniel's Statue and Beasts to Revelation's Composite Beast (christian)
- **christian_christ-returns** - Revelation 19 (christian)
- **christian_covenant-formulas** - "I Will Be Their God, They Will Be My People" (christian)
- **christian_daniel-parallels** - Beast Kingdoms and Son of Man (christian)
- **christian_exodus-parallels** - Plagues and New Exodus (christian)
- **christian_ezekiel-parallels** - Throne Vision and Temple (christian)
- **christian_four-horsemen** - Revelation 6 (christian)
- ... and 24 more


## Comparison by Mythology

| Mythology | Local Files | Firestore Docs |
|-----------|-------------|----------------|
| .claude | 0 | 0 |
| apocryphal | 0 | 0 |
| aztec | 5 | 5 |
...
2. Upload any missing content to Firestore
3. Re-run this script to verify
4. Only proceed with file deletion when validation passes
