...
module.exports = [
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        // View & component globals
        SearchViewComplete: 'writable',
        VirtualScroller: 'writable',
        MythologyOverview: 'writable',
        FirebaseEntityRenderer: 'writable',
        UserDashboard: 'writable',
        AboutPage: 'writable',
        PrivacyPage: 'writable',
        TermsPage: 'writable',
        UserProfileView: 'writable',
        BreadcrumbNav: 'writable',
        AssetCorpusSearch: 'writable',
        EntityDetailViewer: 'writable',
        EntityDisplay: 'writable',
        EntityForm: 'writable',
        EntityLoader: 'writable',
        EntityQuickViewModal: 'writable',
        AlternateNameIndex: 'writable',
        CorpusQueryEditor: 'writable',
        CorpusQueryService: 'writable',
        CorpusQueryTemplates: 'writable',
        ContentFilterService: 'writable',
        AIIconGenerator: 'writable',
        IconGenerator: 'writable',
        ImageUploader: 'writable',
        FirebaseService: 'writable',
        MythologyWhispers: 'writable',
